"""The adaptive sparse grid for LHCD_2D: refinement level and DOF count.
...
from plot_common.grid_methods import main_2d


if __name__ == "__main__":
    main_2d(PATHS, description="LHCD adaptive-grid plots",
             xlabel=r"$\theta$ [deg]", ylabel=r"$x=v/v_{te}$")
